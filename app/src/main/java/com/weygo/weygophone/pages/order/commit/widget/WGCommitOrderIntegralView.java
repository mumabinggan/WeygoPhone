...
public class WGCommitOrderIntegralView extends JHLinearLayout {

    WGCellStyle4View mView;

    public WGCommitOrderIntegralView(Context context) {
        super(context);
    }

    public WGCommitOrderIntegralView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public WGCommitOrderIntegralView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void showWithData(Object object) {
        ...
        if (object instanceof WGCommitOrderDetail) {
            ...
            mView.setTitle(R.string.CommitOrder_Use_Score);
            mView.setDetailTitle(item.getUseIntegrationString());
        }
    }
}
